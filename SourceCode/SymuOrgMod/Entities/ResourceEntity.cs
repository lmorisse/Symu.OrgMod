...
namespace Symu.OrgMod.Entities
{
    ...
    public class ResourceEntity : Entity<ResourceEntity>, IResource
    {
        ...
        public ResourceEntity(GraphMetaNetwork metaNetwork, string name) : base(metaNetwork, metaNetwork?.Resource, Class, name)
        {
        }
        public ResourceEntity(GraphMetaNetwork metaNetwork, byte classId) : base(metaNetwork, metaNetwork?.Resource, classId)
        {
        }
        public ResourceEntity(GraphMetaNetwork metaNetwork, byte classId, string name) : base(metaNetwork, metaNetwork?.Resource, classId, name)
        {
        }
        /// <summary>
